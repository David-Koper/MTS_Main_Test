...
- [x] Видимость блока оплаты при нажатии кнопки "Оплата" на главной странице сайта
- [x] Наличие имиджевого текста на первой странице
- [x] Выполнение поиска заданного тарифа. Проверка, что открылась соответствующая страница и содержимое результатов поиска соответствует заданному, имеется фильтр поиска по "Тарифам"
